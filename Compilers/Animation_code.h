...
class Animation_code {
  public:
    ...
    virtual ~Animation_code(){}
  private:
    std::string block_name;
    std::string parameter_name;
    Gpl_type parameter_type;//RECTANGLE, CIRCLE, etc.
