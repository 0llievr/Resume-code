 ...
 *
 * INPUTS: same as send(2) except len capped at MAX_PACKET_DATA_SIZE
 *
 * RETURN: same as send(2) except a non-negative return value may occur when a packet
 *         is randomly dropped by the function
 */
